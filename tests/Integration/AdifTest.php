...
final class AdifTest extends TestCase
{
    ...
    public function testParseSingleDocument(): void
    {
    ...
    public function testParseMultipleDocuments(): void
    {
        $this->expectNotToPerformAssertions();
    ...
    public function testMergeSingleDocument(): void
    {
        $adif = new Adif();
        $adif->loadFile(testDataPath('p75.adi'));
        $adif->parse();
    ...
    public function testMergeMultipleDocuments(): void
    {
        $adif = new Adif();
        $adif->loadFile(testDataPath('p75.adi'));
    ...
    public function testMergePreservesMetadata(): void
    {
        $adif = new Adif();
        $adif->loadFile(testDataPath('p75.adi'));
        $adif->loadFile(testDataPath('small.adi'));
    ...
    public function testMergeAggregatesTimers(): void
    {
        $adif = new Adif();
        $adif->loadFile(testDataPath('p75.adi'));
        $adif->loadFile(testDataPath('small.adi'));
    ...
    public function testWorkflowLoadParseValidate(): void
    {
        $this->expectNotToPerformAssertions();
    ...
    public function testWorkflowLoadParseDedupe(): void
    {
        $adif = new Adif();
    ...
    public function testWorkflowLoadParseMorph(): void
    {
        $adif = new Adif();
        $adif->loadFile(testDataPath('p75.adi'));
        $adif->parse();
    ...
    public function testWorkflowCompleteProcessing(): void
    {
        $adif = new Adif();
        $adif->loadFile(testDataPath('p75.adi'));
        $adif->parse();
    ...
    public function testMergeWithPotaFerFile(): void
    {
        $adif = new Adif();
    ...
    public function testLoadMixedSources(): void
    {
        $adif = new Adif();
        $adif->loadFile(testDataPath('p75.adi'));
        $adif->loadString("Test\n<eoh>\n<call:5>W1AW<eor>");
    ...
    public function testAdifRoundTrip(): void
    {
        $adif1 = new Adif();
    ...
    public function testTimerTracking(): void
    {
        $adif = new Adif();
        $adif->loadFile(testDataPath('small.adi'));
        $adif->parse();
